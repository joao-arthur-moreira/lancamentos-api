...
CREATE TABLE lancamento (
	codigo BIGINT NOT NULL PRIMARY KEY DEFAULT nextval('seq_lancamento'),
...
INSERT INTO lancamento (descricao, data_vencimento, data_pagamento, valor, observacao, tipo, codigo_categoria, codigo_pessoa) values ('Café', '2017-04-10', '2017-04-10', 4.32, null, 'DESPESA', 4, 3);
